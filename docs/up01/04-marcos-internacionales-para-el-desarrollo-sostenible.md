...
Los problemas relacionados con la sostenibilidad, como el cambio climático, la pérdida de biodiversidad, la pobreza o la desigualdad, superan las fronteras de los países. Por ello, su solución requiere acuerdos y estrategias internacionales que establezcan objetivos comunes. Estos marcos sirven de orientación para que los gobiernos, las empresas y la ciudadanía adopten medidas coordinadas y evalúen sus avances.

## 4.1. Evolución del desarrollo sostenible

La preocupación internacional por los efectos del desarrollo económico aumentó durante la segunda mitad del siglo XX. Algunos de los principales hitos fueron:


| Año { .table-main-column .table-cl-secundario .table-bg-principal } | Iniciativa { .table-cl-secundario .table-bg-principal .table-full-container }| Aportación principal {.table-cl-secundario .table-bg-principal } |
|---|---|---|
...
| 2015 {.table-cl-secundario .table-bg-principal .table-text-bold } | Acuerdo de París. | Reforzó la actuación frente al cambio climático. |
...
| 2019 {.table-cl-secundario .table-bg-principal .table-text-bold } | Pacto Verde Europeo | Definió la estrategia de transición ecológica de la UE. |
...
## 4.2. Principales marcos internacionales

Entre los marcos actuales más importantes encontramos:
...
La Agenda 2030 fue aprobada por las Naciones Unidas en 2015 como un plan de acción mundial para avanzar hacia un modelo de desarrollo más justo y sostenible.
...
La Agenda 2030 tiene carácter universal: no se dirige únicamente a los gobiernos o a los países con mayores dificultades. Todos los países, organizaciones y sectores profesionales pueden contribuir a sus objetivos.

!!! salto-pagina-pdf ""

## 4.4. Objetivos de Desarrollo Sostenible

Los Objetivos de Desarrollo Sostenible (ODS) concretan la Agenda 2030 en 17 objetivos relacionados entre sí:

| Personas y sociedad { .table-full-container .table-cl-secundario .table-bg-principal } | Planeta { .table-cl-secundario .table-bg-principal  }| Economía y prosperidad {.table-cl-secundario .table-bg-principal } |Instituciones y cooperación {.table-cl-secundario .table-bg-principal } |
|---|---|---|---|
| ODS 1. Fin de la pobreza | ODS 6. Agua limpia y saneamiento | **ODS 7. Energía asequible y no contaminante** | **ODS 16. Paz, justicia e instituciones sólidas.**|
| ODS 2. Hambre cero | **ODS 12. Producción y consumo responsables** | **ODS 8. Trabajo decente y crecimiento económico** | ODS 17. Alianzas para lograr los objetivos |
| ODS 3. Salud y bienestar | **ODS 13. Acción por el clima** | **ODS 9. Industria, innovación e infraestructura** | |
| **ODS 4. Educación de calidad** | ODS 14. Vida submarina | ODS 11. Ciudades y comunidades sostenibles. | |
